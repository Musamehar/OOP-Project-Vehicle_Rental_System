...
#include "../../../../include/CustomerDashboard.h"
...
template <> constexpr inline auto CustomerDashboard::qt_create_metaobjectdata<qt_meta_tag_ZN17CustomerDashboardE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'handleRentClicked'
        QtMocHelpers::SlotData<void(const CarData &)>(10, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 11, 12 },
        }}),
    };
...
void CustomerDashboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->showBookingPage(); break;
        case 2: _t->showAboutPage(); break;
        case 3: _t->showTermsPage(); break;
        case 4: _t->showSettingsPage(); break;
        case 5: _t->searchCars(); break;
        case 6: _t->filterCars(); break;
        case 7: _t->logout(); break;
        case 8: _t->handleRentClicked((*reinterpret_cast< std::add_pointer_t<CarData>>(_a[1]))); break;
        default: ;
        }
    }
}
